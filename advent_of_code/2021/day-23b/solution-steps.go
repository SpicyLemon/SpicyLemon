...
func Solve(params *Params) (string, error) {
	...
	burrow := input.Start
	answer := 0
	answer += BurrowMustMove(burrow, RoomSpot(1, 0), HallSpot(5))
	answer += BurrowMustMove(burrow, RoomSpot(1, 1), HallSpot(4))
	...
	answer += BurrowMustMove(burrow, HallSpot(4), RoomSpot(2, 3))
	answer += BurrowMustMove(burrow, HallSpot(5), RoomSpot(2, 2))
	answer += BurrowMustMove(burrow, RoomSpot(3, 0), RoomSpot(2, 1))
	...
	answer += BurrowMustMove(burrow, HallSpot(5), RoomSpot(0, 3))
	answer += BurrowMustMove(burrow, HallSpot(1), RoomSpot(0, 2))
	answer += BurrowMustMove(burrow, HallSpot(0), RoomSpot(0, 1))
