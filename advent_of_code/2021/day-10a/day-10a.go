...
func IncompleteChunkError(expected byte) *ChunkError {
	return &ChunkError{Expected: expected}
}
...
func ParseChunk(str string) *ChunkError {
	...
	return IncompleteChunkError(ClosedBy[str[len(str)-1]])
}
