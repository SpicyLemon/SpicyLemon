#!/bin/bash
# This file contains the go_use_1.19.sh function that switches the go bin symlink to version 1.19.
# This file can be sourced to add the go_use_1.19 function to your environment.
# This file can also be executed to run the go_use_1.19 function without adding it to your environment.
#
