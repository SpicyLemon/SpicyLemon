...
__generic_do_setup () {
    ...
    func_base_file_names=(
        'add'                 'asciidec2text'      'b2h'                 'b642h'                'bash_prompt_newline'
        'beepbeep'            'change_word'        'cpm'                 'echo_color'           'echo_do'
        'find_dead_links'     'fp'                 'getlines'            'h2b64'                'hrr'
        'indiff'              'java_sdk_switcher'  'join_str'            'list'                 'max'
        'min'                 'modulo'             'multi_line_replace'  'multidiff'            'multiply'
