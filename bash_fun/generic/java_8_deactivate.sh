#!/bin/bash
# This file contains the java_8_deactivate function that unsets JAVA_HOME so that you're using the default java version again.
# This file is meant to be sourced to add the java_8_deactivate function to your environment.
#
# File contents:
